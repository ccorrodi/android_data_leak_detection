...
public class FlowdroidParserTest {

    private IParser parser;
    private String testFilePath = System.getProperty("user.dir") + "/testSources/flowdroidTestResults.txt";
    ...
    public void findingsSize() {
        parser = new FlowDroidParser(file);
    ...
    public void getSinkMethodReturn1(){
        assertEquals("int", leaks.get(1).getSinkMethodReturn());
    }
    ...
    public void getMethodName2() {
        assertEquals("sendSMSMessage(java.lang.String)", leaks.get(2).getMethodName());
    }
    ...
    public void getSinkMethod2(){
        assertEquals("sendTextMessage(java.lang.String,java.lang.String," +
                "java.lang.String,android.app.PendingIntent,android.app.PendingIntent)",
                leaks.get(2).getSinkMethod());
    }
